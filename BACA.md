...
| Komponen Lainnya| • Kabel jumper (1 set)<br>• KCD11: Saklar Pengayun SPST (x1)<br>• Adaptor DC 12V 2A (x1)<br>• Motor driver L298N (x1)<br>• Breadboard (x1)<br>• Potensiometer (x1)<br>• Tombol tekan 12 x 12 mm (x2)<br>• Stiker kayu (1 set)<br>• Papan kayu (x2) |
